...
@WebServlet("/deleteinwardlrdetails")
public class DeleteInwardLRDetails extends HttpServlet
{
	public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
	{
		...
		else
		{
	        ...
	        st=con.createStatement();
	        //rs=null;
	        int i=(int)st.executeUpdate("DELETE FROM inward_lr_details WHERE inward_lr_details_id='"+inward_lr_details_id+"'");
	        
            
	      	if(i>0)
            {
            	RequestDispatcher rd=req.getRequestDispatcher("DeleteInwardLRDetailsSuccess.jsp");
				rd.forward(req,res);
            }

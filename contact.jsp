					...
					<div class="navbar-top">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							 <ul class="nav navbar-nav link-effect-4">
								...
								<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span data-letters="Pages">Login</span><span class="caret"></span></a>
									<ul class="dropdown-menu"> 
										<li><a href="userlogin">User Login</a></li>
										<li><a href="adminlogin">Admin Login</a></li>
									</ul>
								</li>     
								<li class="active first-list"><a href="contact">Contact</a></li>
							  </ul>
							</div><!-- /.navbar-collapse -->
						</div>
				</div>
			...
			<div class="contact-agileinfo">
				...
				<div class="col-md-4 contact-right wthree">
					<div class="contact-text w3-agileits">
						<h4>GET IN TOUCH :</h4>
						<p><i class="fa fa-map-marker"></i> 88/3,M.G. Road,Kolkata-700196</p>
						<p><i class="fa fa-phone"></i> Telephone : (+91)9856124789</p>
						<p><i class="fa fa-envelope-o"></i> Email : <a href="goramalBalmukand22@yahoo.com">goramalBalmukand22@yahoo.com</a></p> 
					</div> 
				</div> 
				<div class="clearfix"> </div>	
			</div>

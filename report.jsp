					...
					<div class="navbar-top">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							 <ul class="nav navbar-nav link-effect-4" style="display:inline-block;">
							 	...
							 	<li class="active first-list"><a href="#">Report</a></li>
...
<div class= "container">
  ...
  <div class="col mb-6">
    <div class="card text-white bg-dark mb-3 text-center" style="border-radius: 20px;">
  	<div class="card-header"><h5 class="card-title">Stock Report</h5></div>
  	<div class="card-body">
  	<p class="card-text"><h6>Details of Stock</h6></p>
    <a href="S_Report" class="btn btn-danger">Go</a>
  	</div>
	</div>
  </div>
  <div class="col mb-6">
    <div class="card text-white bg-dark mb-3 text-center" style="border-radius: 20px;">
  	<div class="card-header"><h5 class="card-title">Trasportation Report</h5></div>
  	<div class="card-body">
  	<p class="card-text"><h6>Details of Tranportation</h6></p>
    <a href="T_Report" class="btn btn-danger">Go</a>
  	</div>
	</div>
  </div>
</div>

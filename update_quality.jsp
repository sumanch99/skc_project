...
<%
	List<String> quality = (ArrayList)session.getAttribute("quality");
%>
<form action="qualitymasterupdate" method="get">
	<input type="hidden" name="q_id" value="<%=quality.get(0)%>">
  <div class="form-row">
    <div class="form-group col-md-4">
      <label name = "quality Name">quality Name</label>
      <input type="text" class="form-control" placeholder="Enter quality Name" name="quality" value="<%=quality.get(1)%>" required>
    </div>
    <%
    	List<String> consigners = (ArrayList)session.getAttribute("consigners");
    	Iterator iter2 = consigners.iterator();
    	String ch="";
    %>
    <div class="form-group col-md-4">
      ...
      <%  while(iter2.hasNext())
      		{ %>
            	...
            	<%ch =iter2.next().toString();%>
            	<%if((quality.get(2)).equals(ch))
            		{%>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" placeholder="Enter Address" name="hsncode" value="<%=quality.get(3)%>" required>
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="Contact No">Quality Description</label>
      <input type="text" class="form-control" placeholder="Enter Contact No." name="q_desc" value="<%=quality.get(4)%>" required="">
    </div>
        <div class="form-group col-md-4">
      <label for="Gst No">CGST Rate</label>
      <input type="text" class="form-control" placeholder="Enter Gst No." name="cgst" value="<%=quality.get(5)%>" required="">
    </div>
     <div class="form-group col-md-4">
      <label for="Gst No">SGST Rate</label>
      <input type="text" class="form-control" placeholder="Enter Gst No." name="sgst" value="<%=quality.get(6)%>" required="">
    </div>
  </div>
  <center>

        ...
        <div class="container">
          <div class="navbar-top">
              ...
              <ul class="nav navbar-nav link-effect-4" style="display:inline-block;">
                ...
                <li class="active first-list"><a href="userprofile">Profile</a></li>
    	...
    	<div class="col-sm-12">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="updateuserprofile" method="get" id="registrationForm" onsubmit="return fun();">
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                              <label for="first_name"><h4>Name</h4></label>
                              <input type="text" class="form-control" name="name" id="name" placeholder="first name" title="enter your name" value="<%=userProfile.get(1)%>" required disabled="">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="last_name"><h4>User Name</h4></label>
                              <input type="text" class="form-control" name="username" id="username" placeholder="last name" title="enter your last name if any." value="<%=userProfile.get(0)%>" disabled="">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="number" id="number" placeholder="enter your contact number" title="enter your contact number" required disabled="" value="<%=userProfile.get(3)%>">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                              ...
                              <input type="email" class="form-control" name="email" id="email" placeholder="you@email.com" required title="enter your email." disabled="" value="<%=userProfile.get(2)%>"> 
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                              	<input class="btn btn-lg btn-success" type="submit" value="Update" id="btn1">
                               	<input class="btn btn-lg" style="background-color: grey;" type="reset" value="Reset" id="btn2">
                            </div>
                      </div>
                    </div>
              	</form>
